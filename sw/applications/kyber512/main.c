...
int main(void)
{
    ...
    for(int i=0; i<NTESTS; i++) {
        ...
        //*************************************************
            ...
            PQCLEAN_KYBER512_CLEAN_crypto_kem_keypair_derand(pk, sk, keypair_rnd);
        ...
        //*************************************************
            ...
            PQCLEAN_KYBER512_CLEAN_crypto_kem_enc_derand(ct, key_b, pk, encaps_rnd);
        ...
        //*************************************************
            ...
            PQCLEAN_KYBER512_CLEAN_crypto_kem_dec(key_a, ct, sk);
